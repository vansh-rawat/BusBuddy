                    ...
                    <Col lg={12} xs={24} sm={24}>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <StripeCheckout
                                ...
                                currency='INR'
                                stripeKey="pk_test_51NLS3uSF5drSiKTOqSB0Iy70h1rIuU0UhlFJYlmW7ntOXij2LLBtFZNAavrTYiahhMXG46sruFR8N21aNBI7KGfv0053uizLsp"
                            >

                                <button className={`btn primary-btn ${selectedSeats.length === 0 && 'disabled-btn'}`}
